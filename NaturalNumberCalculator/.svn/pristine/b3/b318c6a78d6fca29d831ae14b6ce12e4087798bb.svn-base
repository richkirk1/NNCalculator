...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
        ...
        this.bPower = new JButton("x\u207F");
        this.bRoot = new JButton("\u221A");
        this.bDigits = new JButton[DIGIT_BUTTONS];
        for (int b = 0; b < this.bDigits.length; b++) {
            this.bDigits[b] = new JButton("" + b);
        }
         ...
         * to bottom
         */
        mainButtonPanel.add(this.bDigits[Integer.parseInt("7")]);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("8")]);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("9")]);
        mainButtonPanel.add(this.bAdd);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("4")]);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("5")]);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("6")]);
        mainButtonPanel.add(this.bSubtract);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("1")]);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("2")]);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("3")]);
        mainButtonPanel.add(this.bMultiply);
        mainButtonPanel.add(this.bDigits[Integer.parseInt("0")]);
        ...
        for (int b = 0; b < this.bDigits.length; b++) {
            this.bDigits[b].addActionListener(this);
        }
